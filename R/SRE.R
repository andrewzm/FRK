...
#' @param new_BAU_data A \code{data.frame} containing updated covariate values at the BAU level. Must have the same number of rows, column names  (in the same order), and column types as the original BAUs data. If \code{NULL} (default), the original BAUs data will be used.
